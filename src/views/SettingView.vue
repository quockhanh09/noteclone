      ...
      <form class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="form-input select-icon" >
            <select class="form-control" id="TimeZone" name="TimeZone" fdprocessedid="2bp36g">
        ...
        <div class="form-group">
          <label class="content control-label">Password</label>
          <div class="form-input select-icon">
            <select class="form-control" id="Theme" name="Theme" fdprocessedid="ma97hy">
        ...
        <div class="form-group">
          ...
          <div class="form-input">
            <input type="submit" class="btn btn-primary btnd" value="Download Notes" />
        </div>
        </div>
        <p class="text-Setting">Delete Account</p>
        <p class="text-account">
            Deleting your account will permanently delete your information along with all of your notes.
            <br>
            This can not be undone. If you delete your account, your notes can not be retrieved.
        </p>
        <p class="text-account">
      <input
        type="checkbox"
